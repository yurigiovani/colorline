...
function initSprites(img) {
	...
	s_buttons = {
		...
		Retry: new Sprite(img, 98, 129, 55, 19),
		Start: new Sprite(img, 159, 191, 40, 14)
	}

	s_bestscore = new Sprite(img, 0, 0, 92, 48);
	s_score 	= new Sprite(img, 0, 57, 92, 48);
	s_splash 	= new Sprite(img, 0, 116, 86, 73);

	s_numberScore = new Sprite(img, 0, 195, 12, 14);
	s_numberGame = new Sprite(img, 0, 211, 12, 14);
	 ...
	 */
	s_numberScore.draw = s_numberGame.draw = function(ctx, x, y, num, center, offset) {
		num = num.toString();
